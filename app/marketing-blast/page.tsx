...
const bodyHTML = `
  ...
  <main>
    <!-- HERO -->
    <section class="pt-16 sm:pt-24 pb-10 sm:pb-14 px-4 sm:px-6 bg-white">
    ...
    <section class="pb-20 sm:pb-28 px-4 sm:px-6">
      <div class="max-w-6xl mx-auto grid lg:grid-cols-2 gap-6 lg:gap-8 items-start">

        <!-- CARD 1: Appointment Confirmation Calls -->
        <div class="card-lift rounded-2xl bg-white border-2 border-brand-green/20 p-6 sm:p-8 flex flex-col relative shadow-sm">
          ...
          <div class="bg-brand-pageBg rounded-xl p-5 mb-6 border border-brand-border">
            <div class="flex flex-wrap gap-x-6 gap-y-3">
              ...
              <div class="border-l border-brand-border pl-6">
                <span class="text-xs text-brand-subtle uppercase tracking-wide font-medium block mb-1">Monthly</span>
                <span class="text-2xl font-bold text-brand-green">$29</span>
                <span class="text-sm text-brand-muted ml-1">/mo</span>
              </div>
            </div>
          ...
          <div class="text-center">
            ...
            <p class="text-xs text-brand-subtle mt-3">then $29/month &middot; cancel anytime</p>
        ...
        <div class="card-lift rounded-2xl bg-white border border-brand-border p-6 sm:p-8 flex flex-col shadow-sm">
          <div class="mb-5">
          ...
          <div class="text-center">
            <a href="#contact" class="inline-flex items-center justify-center w-full gap-2 bg-brand-dark hover:bg-gray-800 text-white font-bold text-base px-6 py-4 rounded-xl transition-all duration-200 transform hover:scale-[1.02]">
              Start a Campaign
              <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6"/></svg>
            </a>
            <p class="text-xs text-brand-subtle mt-3">Priced per 1,000 contacts &middot; no monthly fee</p>
          </div>
        </div>
    ...
    <!-- CONTACT CTA -->
    <section id="contact" class="py-16 sm:py-20 px-4 sm:px-6 border-t border-brand-border bg-brand-pageBg">
  ...
  return (
    <>
      <style>{`
        ...
        .green-glow { box-shadow: 0 4px 20px rgba(34,197,94,0.25); }
        .green-glow:hover { box-shadow: 0 6px 30px rgba(34,197,94,0.4); }
