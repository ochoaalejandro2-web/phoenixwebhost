...
export const copy = {
  en: {
    ...
    templatesTitle: "Eight professional starting points",
    templatesLead:
    ...
    searchPlaceholder: "Carpentry, handyman, landscaping…",
  ...
  es: {
    ...
    templatesTitle: "Ocho puntos de partida profesionales",
    templatesLead:
    ...
    searchPlaceholder: "Carpintería, manitas, jardinería…",
