...
export const copy = {
  en: {
    ...
    howSteps: [
      {
        n: "1",
        t: "You request a site",
        d: "Name, phone, hours, a few sentences, and any photo you already have.",
      },
      {
        n: "2",
      ...
      {
        n: "3",
        t: "We put the site live",
        d: "On a subdomain like yourshop.phoenixwebhost.com. Point a custom domain with a CNAME when you are ready.",
      },
    ],
    ...
    howSteps: [
      {
        n: "1",
        t: "Pide un sitio",
        d: "Nombre, teléfono, horario, unas frases y cualquier foto que ya tenga.",
      },
      {
        n: "2",
      ...
      {
        n: "3",
        t: "Publicamos el sitio",
        d: "En un subdominio como sunegocio.phoenixwebhost.com. Cuando quiera, apunta un dominio propio con un CNAME.",
      },
    ],
