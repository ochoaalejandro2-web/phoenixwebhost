...
export const PUBLIC_DEMOS: PublicDemo[] = [
  ...
  },
  {
    ...
    name: "Premium Carpentry Designs",
    city: "Phoenix, AZ",
    template: "carpentry",
    href: demoHref("premium-carpentry-designs"),
    hostLabel: "phoenixwebhost.com/s/premium-carpentry-designs",
    services: [
      "Custom cabinets",
      "Built-ins",
      "Furniture",
  ...
  {
    slug: "the-sharp-cut",
    name: "The Sharp Cut Barbershop",
    city: "Phoenix, AZ",
    template: "salon",
    href: demoHref("the-sharp-cut"),
    hostLabel: demoHost("the-sharp-cut"),
    services: [
      "Executive Haircut",
